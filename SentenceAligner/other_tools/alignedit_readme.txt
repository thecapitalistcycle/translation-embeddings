...
Due to a bug that is outside my control, the vertical scrollbar may not show up in some cases. Resize the window to make it pop up. Due to another bug, the cursor may not always go where you click. Use the keyboard shortcuts to navigate if it gets annoying.