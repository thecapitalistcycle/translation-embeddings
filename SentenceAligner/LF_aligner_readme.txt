...
Hunalign tips:
Hunalign works even better if it is given a bilingual dictionary. LF Aligner comes with premade dictionaries for more than 800 language combinations covering all EU languages and many more. (Dictionaries are generated on an 'as needed' basis during the alignment process.) If the "Dictionary used by Hunalign" is reported to be anything other than null.dic, then your language combination is covered by the built-in dictionary data. If your language pair is not covered or you want to improve the dictionary, you can add any dictionary data you wish. A mix of large glossaries in the areas you work in is probably best, but throw in a large general dictionary as well for good measure. Don't hold back, it can easily handle dictionaries with hundreds of thousands of entries.
